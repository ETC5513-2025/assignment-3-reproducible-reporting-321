...
::: columns
::: {.column width="60%"}
![](images/cases_vaccination.png){width="100%"}
:::

::: {.column width="100%" style="font-size: 60%;"}
::: {style="font-weight: bold; font-size: 80%; margin-bottom: 0.6em;"}
Vaccination Rolled Out After Cases Rose
:::

-   This figure overlays confirmed COVID-19 case rates and vaccination
    rates.\
-   Case surges often occurred **before** vaccination began.\
-   Many countries began vaccinating **after** major outbreaks had
    already started.
:::
:::
...
::: {.column width="60%"}
![](images/cases_deaths_vaccination.png){width="100%"}
:::

::: {.column width="45%" style="font-size: 60%;"}
<div style="font-weight: bold; font-size: 80%; margin-bottom: 0.6em;">
...
::: {.column width="60%"}
![](images/lagged_vaccination_vs_cases.png){width="100%"}
:::
